...
const STYLES = {
  ...
  COPY_BUTTON: "flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all duration-200",
        ...
        <div className={STYLES.ACTIONS_CONTAINER}>
          {!isPublic && userInfo?.username && (
            ...
            >
              ...
              <span>{copied ? "¡Copiado!" : "Enlace Público"}</span>
            </button>
          )}
