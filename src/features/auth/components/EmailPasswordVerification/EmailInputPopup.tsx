...
const EMAIL_INPUT = "w-full bg-black rounded-lg px-4 py-3 text-[#FFFFFF] placeholder:text-white/40 outline-none mb-3";
    ...
    <div className={EMAIL_CONTAINER}>
      <div className={EMAIL_CARD}>
        ...
        <p className={EMAIL_DESCRIPTION}>
          Por favor, ingresa tu dirección de correo para continuar y mantener tu cuenta segura.
        </p>
        ...
        <div className={EMAIL_BUTTONS_WRAPPER}>
          <Button variant="secondary" onClick={onSubmit} fullWidth>
            Añadir
          </Button>
