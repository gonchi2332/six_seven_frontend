...
const LEVEL_BUTTON_BASE ="w-9 h-9 rounded-full border-2 font-inter font-bold text-[15px] transition-all duration-200 cursor-pointer";
const LEVEL_BUTTON_ACTIVE = "bg-white border-white text-black";
