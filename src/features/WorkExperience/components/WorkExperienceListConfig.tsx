...
const WorkExperienceListConfig = () => {
                ...
                <div className={styles.outerCard}>
                    <div className={styles.greenContainer}>
                        <div className={styles.header}>
                            <h1 className={styles.title}>Configuración de visibilidad de Experiencia Laboral</h1>
                        ...
                        {isLoading ? (
                            ...
                            <div className={styles.listWrapper}>
                                {paginatedExperiences.map((experience) => {
                                    const currentVisibility = visibilityMap[experience.id] ?? (experience as any).is_visible ?? (experience as any).visible ?? false;
                                    return (
...
export default WorkExperienceListConfig;
